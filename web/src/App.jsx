...
const СКАЧАТЬ = [
  ...
  {
    href: BASE + 'pdf/10L-tablica.pdf',
    title: 'Лист на стену',
    text: 'Вся неделя одной таблицей на одном листе. Без цвета и заливок — печатается на чёрно-белом принтере и не съедает тонер.',
    tag: 'A4 поперёк · 1 полоса',
  },
  {
